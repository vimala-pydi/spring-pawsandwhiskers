...
# Compile servlet
javac -classpath "$TOMCAT_PATH/lib/servlet-api.jar" $PROJECT_ROOT/libs/*" -d "$PROJECT_ROOT/target/classes" "$PROJECT_ROOT/src/main/java/servlets/ImageDisplayServlet.java"
